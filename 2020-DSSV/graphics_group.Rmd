...
<img src="image/nyt.gif" class = "topleftfig" width="95%"/>

.pull-right-more[
<h3 class='emph cerulean'>General Timeline</h3>

- Dec 31, 2019 - China report to WHO
- Jan 14 - WHO suggests human-to-human transmission
- Jan 21 - US announces first case
- Jan 23 - Hubei province is locked down
- Feb 4 - Diamond Princess quarantined
- Feb 26 - California community transmission
- March 7 - 100k global cases
- March 11 - WHO declares pandemic
- April 2 - WHO suggests asymptomatic/presymptomatic transmission

<br/>
.small[NYT Front page graphic inspired by [@joshbegley](https://twitter.com/joshbegley/status/1243520269307838465).]
...
- About [10% of COVID-19 cases lead to 80% of the spread](https://www.sciencemag.org/news/2020/05/why-do-some-covid-19-patients-infect-many-others-whereas-most-don-t-spread-virus-all)
  - .small[Super spreading events make up the difference]
  - .small[Small increases in the number of cases may signal a huge problem]
...
.small.center[Recreated from a chart in a 
