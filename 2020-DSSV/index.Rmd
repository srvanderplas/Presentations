...
```{r, fig.show='animate', ffmpeg.format='gif', fig.width = 8, fig.height = 4, dev = "jpeg", dpi = 300, interval = 0.5}
show_states2 <- c("Washington", "Texas", "California", "Arizona", "Nebraska", "New York")
...
I love graphics, and data, but I'll confess that by about May, I was done. I just couldn't look at another one of these charts. I still wanted to know how bad things were in the areas of the country I care about - places where friends and family live, but I was so done 
