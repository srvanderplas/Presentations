...
ggplot(data = tmp, aes(x = date, y = cases)) + 
  ...
  scale_fill_manual("x10k\nTotal\nCases",
                    values = colorRampPalette(colors = c("white", "yellow", "orange", "red"), bias = .5, space = "Lab")(50)) + 
  theme(axis.title = element_blank(), plot.background = element_rect(fill = "transparent", color = NA), panel.background = element_rect(fill = "transparent", color = NA), legend.background = element_rect(fill = "transparent", color = NA)) 
...
```{r}
show_states2 <- c("Washington", "Texas", "California", "Arizona", "Nebraska", "New York", "Iowa", "Florida")
