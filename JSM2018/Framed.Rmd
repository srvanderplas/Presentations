...
- Goal: Show the makeup of the country
    - Maps
...
- The Census Bureau and assocciated institutions did a great job of "reproducibility" with data    

--

## 150 years later, and we can use completely different technology to get the same charts