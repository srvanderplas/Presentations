...
This one wasn't really anyone's fault, per se - the supplier we used for the experiment changed their supplier, and suddenly we were using film with a different background and different tint than before. In the grand scheme of things, this is not much, but it really complicated any processing I was attempting to automate.
...
The study has been completed for about 3 years now, and I'm still working on building a proper analysis pipeline. We've actually gone back to even more fundamental research - trying to figure out what we can even detect, and what the sources of error are, when we take a print. In many other forensics disciplines, you can remove the "class characteristics" - the shared patterns between two items of the same manufacture - very easily, but with shoes... it's much harder and may be impossible to do. 
