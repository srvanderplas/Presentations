...
- __My Project__: Use computer vision techniques to improve automatic identification of regions of interest in 3D scans of bullet land engraved areas and cartridge cases

<br/><br/>
Example: Bullet Land Engraved Areas

Vertical Line Detection | Annotated x3p bullet scan
--- | ---
<img src="images/bulletQuality/Automatically_marked_hough_transform.png" width = "100%" style="clip:rect(100px,0px,100px,0px)"/> | <img src="images/bulletQuality/Automatically_marked_grooves.png" width = "100%"/>
...
Worked as a statistical analyst from 2015 - 2018 at     
Nebraska Public Power District (Cooper Nuclear Station)    
Responsibilities:
  - Developed an internal program to train employees in R and data science
  
  - Statistical analyses in response to NRC inquiries
  
  - Predict time to complete critical tasks based on equipment reliability and previous performance.
  
  - HR Analytics: Predict resignations, retirements, identify high turnover departments
