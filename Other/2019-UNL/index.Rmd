...
I started at CSAFE in March 2018, and since then I've worked on several projects that are nearing completion. Today, I'm going to talk about a Convolutional Neural Network for Outsole recognition, or CoNNOR for short. The statistical methods I'll discuss can be applied to domains far outside of forensics, but the forensics problem is particularly fun. 
