...
Citep(bb, "benedict_geographical_2014", .opts = list(max.names = 1, longnamesfirst = F))
```
...
- Research Area: Visualization and Statistical Computing
...
---
class:inv-center
# What is the probability the suspect's shoe made this shoeprint from the crime scene?

---
class:primary
## What is<br/>P(someone made this print)?
...
- Most CNNs require > 100K images during training
    - Convolutional base of VGG16 for 256 x 256 x 3 images has __14,714,688__ parameters `r Citep(bb, 'simonyan_very_2014', .opts = list(max.names = 1, longnamesfirst = F))`
