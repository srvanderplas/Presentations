...
- Simple model head (9 output classes): ~8.3 million parameters

- Total parameter space: ~22.8 million
...
- Total parameter space: 8.3 million

--

#### VGG16
- pre-trained CNN `r Citep(bb, 'simonyan_very_2014', .opts = list(max.names = 1, longnamesfirst = F))`
    - Trained on 1.3 million images from ImageNet `r Citep(bb, 'krizhevsky_imagenet_2012', .opts = list(max.names = 1, longnamesfirst=F))`
