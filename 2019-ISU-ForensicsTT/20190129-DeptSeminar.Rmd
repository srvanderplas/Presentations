...
Let $f$ be an image represented as a numerical matrix, indexed by $i, j$. 

The convolution of image $f$ and filter $\omega$ is $$(\omega \ast f)(i, j) = \sum_{s = -a}^a\sum_{t = -b}^b w(s, t) f(i-s, j-t)$$
