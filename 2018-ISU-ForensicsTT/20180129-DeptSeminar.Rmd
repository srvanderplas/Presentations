...
BibOptions(check.entries = FALSE, 
           ...
           style = "html",
           hyperlink = FALSE, 
           no.print.fields = c("url", "isbn", "note"),
           dashed = FALSE)
...
- Fit using the `keras` package in R, which provides a high-level API for the `tensorflow` library `r Citep(bb, 'chollet_deep_2018')`
...
>>>>>>> 3c943582ac8516b9a9e4c882a05a7faed23bcc27
