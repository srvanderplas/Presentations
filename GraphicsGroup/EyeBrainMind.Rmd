...
- Memories are stored as "gist" - the idea of the thing, rather than the actual perception
...
- Physiological Illusions occur due to receptor "wiring"

![Grid illusion](https://en.wikipedia.org/wiki/Grid_illusion#/media/File:Grid_illusion.svg)
...
<img src=https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Cup_or_faces_paradox.svg/174px-Cup_or_faces_paradox.svg width="40%"/>
.right[![Kanizsa triangle illusion](https://en.wikipedia.org/wiki/Illusory_contours#/media/File:Kanizsa_triangle.svg)]
