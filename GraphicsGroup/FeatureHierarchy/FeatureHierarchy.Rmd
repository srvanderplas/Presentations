...
<img src="figure/set-48-k-5-sdline-0.45-sdgroup-0.25-TREND.png"  style="display:block;margin-left:auto;margin-right:auto;" width="50%"/>

## Which plots are the most different?

<img src="figure/set-48-k-5-sdline-0.45-sdgroup-0.25-COLOR.png"  style="display:block;margin-left:auto;margin-right:auto;" width="50%"/>
...
<li class = "fragment">Plot 12: 59.1%</li>
<li class = "fragment">Plot 5: 9.1%</li>
...
<li class = "fragment">Plot 12: 9.7% </li>
<li class = "fragment">Plot 5: 29.0% </li>
...
<p class="double">
<img src="figure/89903c2363590827b167328f09a9f076.png" width = "50%" class="one-col-image" style="margin-bottom:auto;"/><br/><br/>
<p class = "fragment">Some of the null plots were missing an ellipse - We failed to enforce group size constraints on k-means algorithm.</p>
</p>
