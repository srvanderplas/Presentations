...
<p>[In Progress]<cite>
S. VanderPlas.
&ldquo;BulletsamplR: Resampling Bullet Cross Sections&rdquo; To be submitted to Forensic Science International Summer 2019.</cite></p>
...
I started at CSAFE in March 2018, and since then I've worked on several projects that are nearing completion. Today, I'm going to talk about a Convolutional Neural Network for Outsole recognition, or CoNNOR for short. 
...
----------------- | ----------
![](prototype/20190328_152218.jpg) | ![](prototype/GOPR1231-blur-enhance.JPG)
...
Unfortunately, I didn't take a whole lot of classes in gadget design while I was doing my PhD. This is a problem for engineers, and a couple of very good ones have assured me that this is doable, and have built a working prototype. 
...
During this portion of the talk, I'm going to walk through a convolutional neural network, discuss the components, and describe the process of model fitting. I'm going to be fairly brief, but these models can sometimes be treated as magic, so I hope that I can ruin that for you today.
...
- Automation of model training (runs daily at 5pm if there is new data)
