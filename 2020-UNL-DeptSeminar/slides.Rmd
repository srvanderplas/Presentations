...
- Can't determine the total number of different source comparisons -- can only simulate it using logic
...
![The distribution of inconclusives should be equivalent to the ratio of same-source and different-source comparisons](images/shape-overview.png)
