...
<ul>
<li>Compare 2016 total compensation    
(base pay + overtime, shift differentials, bonuses)</li>
<li>Methods:
  <ul>
...
<li> Repeat the same analysis using annual compensation (base pay only)</li>
</ul>
