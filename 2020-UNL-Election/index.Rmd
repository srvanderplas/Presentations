...
author: "Susan Vanderplas.small.bottom[joint work with Kiegan Rice, Heike Hofmann]"
...
- [`electionViz` package](#electionviz)

- [A Brief Tour of (In)famous Election Graphics](#tour)

- [Why are election graphics complicated?](#complicated)
